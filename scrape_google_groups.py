...
# SET LINE 84 TO YOUR FIRFOX BINARY PATH!
class GoogleGroupsScraper(object):
    ...
    def _get_driver(self):
        ...
        # YOU'LL NEED TO SET PATH TO WHERE EVER THE FIREFOX
        # BINARY IS LOCATED ON YOUR SYSTEM.
        # IF YOU ARE RUNNING FIREFOX HEADLESS, CHECK OUT:
        # http://www.installationpage.com/selenium/how-to-run-selenium-headless-firefox-in-ubuntu/
        path = 'C:/Program Files/Mozilla Firefox/firefox.exe'
        binary = FirefoxBinary(firefox_path=path)
    ...
    def _get_all_message_buttons(self):
        ...
        timeline = self.driver.find_element(By.ID, 'tm-tl')
        all_buttons = timeline.find_elements(By.CLASS_NAME, 'jfk-button-standard')
    ...
    def _get_post_list(self):
        ...
        toReturn = self.driver.find_elements(By.CLASS_NAME, 'ZLl54')
        return toReturn
    ...
    def _get_urls_from_post_list(self, post_list):
        ...
        urls = [el.get_attribute('href') for el in post_list]
        urls = [url for url in urls if url and url.startswith('https://groups.google.com/forum/')]
...
if __name__ == "__main__":
    # forum_url = sys.argv[1]
    # print(forum_url)
    forum_url = 'https://groups.google.com/forum/#!forum/mumbai-ultimate'
    #forum_url = 'https://groups.google.com/forum/#!forum/mitmproxy'
